...
func _setup_noise() -> void:
	# Broad fBm volume. The shader samples this at multiple physical scales; this
	# texture is generated by Godot and is independent from the temporary visual
	# reference package.
...
func _setup_material() -> void:
	...
	# Deep tropical convection can reach 16-18 km. Keep one continuous spherical
	# shell rather than swapping to an unrelated orbit representation.
