...
func gpu_stats() -> Dictionary:
	...
	physical["cfl_persistent_live_slot_queue"] = cached_cfl
	physical["cfl_live_slot_indirect_reduction"] = cached_cfl
	physical["cfl_fine_tick_capacity_scan"] = not cached_cfl
