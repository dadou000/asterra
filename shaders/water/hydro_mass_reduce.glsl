...
// One partial depth sum per 8x8 workgroup. Keeping this separate from the health
// reduction avoids requiring non-portable floating-point atomics.
...
void main() {
    ...
    if (lane == 0u) {
        uint groups_x = gl_NumWorkGroups.x;
