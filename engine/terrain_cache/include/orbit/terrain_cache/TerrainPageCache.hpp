...
struct TerrainPageCacheConfig
{
    ...
    // Temporary source compatibility for callers that still initialize
    // maxEntries. Byte budgeting remains authoritative; new code should use
    // softEntryLimit for a secondary entry-count safety guard.
