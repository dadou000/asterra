    ...
    schema::SchemaRegistry& schemas)
{
    ...
    schemas.RegisterType({
        ...
        .properties = {
            ...
            {.id = kAuroraIntensity,
             ...
             .defaultValue = 1.0,
             .range = {.minimum = 0.0}},
            {.id = kAuroraColorLinear,
             .name = "Auroral Emission Color",
             .kind = schema::PropertyKind::Vector3,
             .defaultValue = math::Double3{0.12, 1.8, 0.42}},
            {.id = kAuroraStructure,
             .name = "Auroral Structure",
             .kind = schema::PropertyKind::Float,
             .defaultValue = 0.65,
             .range = {.minimum = 0.0, .maximum = 1.0}},
            {.id = kAuroraSeed,
    ...
    schemas.RegisterType({
        .id = kCompactObjectCapabilityType,
        .displayName = "Compact Object",
        .category = "Celestial/Capability",
        .properties = {
            EnabledProperty(),
            ModelProperty("Schwarzschild Baseline"),
            {.id = kCompactGravitationalParameter,
             .name = "Gravitational Parameter",
             .kind = schema::PropertyKind::Float,
             .unit = "m^3/s^2",
             .defaultValue = 1.3271645321e20,
             .range = {.minimum = 1.0}},
            {.id = kCompactDimensionlessSpin,
             .name = "Dimensionless Spin",
             .kind = schema::PropertyKind::Float,
             .defaultValue = 0.0,
             .range = {.minimum = -1.0, .maximum = 1.0},
             .advanced = true},
            {.id = kCompactSpinAxis,
             ...
             .defaultValue = math::Double3{0.0, 0.0, 1.0},
             .advanced = true},
            {.id = kCompactShadowScale,
             .name = "Shadow Scale",
             .kind = schema::PropertyKind::Float,
             .defaultValue = 1.0,
             .range = {.minimum = 0.1},
             .advanced = true},
            {.id = kCompactLensingStrength,
             .name = "Lensing Strength",
             .kind = schema::PropertyKind::Float,
             .defaultValue = 1.0,
             .range = {.minimum = 0.0},
             .advanced = true},
            {.id = kCompactPhotonRingIntensity,
             .name = "Photon Ring Intensity",
             .kind = schema::PropertyKind::Float,
             .defaultValue = 1.0,
             .range = {.minimum = 0.0}}
        }
    ...
    schemas.RegisterType({
        .id = kAccretionFlowCapabilityType,
        .displayName = "Accretion Flow",
        .category = "Celestial/Capability",
        .properties = {
            EnabledProperty(),
            ModelProperty("Thin Flow Baseline"),
            {.id = kAccretionInnerRadiusRg,
             .name = "Inner Radius",
             .kind = schema::PropertyKind::Float,
             .unit = "rg",
             .defaultValue = 6.0,
             .range = {.minimum = 1.0}},
            {.id = kAccretionOuterRadiusRg,
             .name = "Outer Radius",
             .kind = schema::PropertyKind::Float,
             .unit = "rg",
             .defaultValue = 40.0,
            ...
            {.id = kAccretionAxis,
             ...
             .kind = schema::PropertyKind::Vector3,
             .defaultValue = math::Double3{0.0, 0.0, 1.0}},
            {.id = kAccretionColorLinear,
             .name = "Emission Color",
             .kind = schema::PropertyKind::Vector3,
             .defaultValue = math::Double3{1.4, 0.42, 0.08}},
            {.id = kAccretionIntensity,
             .name = "Emission Intensity",
             .kind = schema::PropertyKind::Float,
             .defaultValue = 1.0,
             .range = {.minimum = 0.0}},
            {.id = kAccretionTemperatureKelvin,
             .name = "Characteristic Temperature",
             .kind = schema::PropertyKind::Float,
             .unit = "K",
             .defaultValue = 8000000.0,
             .range = {.minimum = 1.0},
             .advanced = true},
            {.id = kAccretionRadialFalloffExponent,
             .name = "Radial Falloff",
             .kind = schema::PropertyKind::Float,
             .defaultValue = 2.0,
             .range = {.minimum = 0.01},
             .advanced = true},
            {.id = kAccretionThicknessRatio,
             .name = "Thickness Ratio",
             .kind = schema::PropertyKind::Float,
             .defaultValue = 0.08,
             .range = {.minimum = 0.0, .maximum = 1.0}},
            {.id = kAccretionDopplerStrength,
             .name = "Doppler Strength",
             .kind = schema::PropertyKind::Float,
             .defaultValue = 0.45,
             .range = {.minimum = 0.0, .maximum = 1.0},
             .advanced = true},
