    ...
    const terrain::PhysicalTerrainPageAddress& address)
{
    ...
    do
    {
        ...
        // These products are generated by worker threads. A tiny sleep avoids
        // starving them while this synchronous verification helper advances
        // the Studio session from the UI thread.
