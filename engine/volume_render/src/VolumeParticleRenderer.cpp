      ...
      state_(device, compiler, framesInFlight)
{
    ...
    if (vertex.bytecode.empty() || pixel.bytecode.empty() || splashVertex.bytecode.empty() || splashPixel.bytecode.empty() || dropletVertex.bytecode.empty() || dropletPixel.bytecode.empty() || oitCompositeVertex.bytecode.empty() || oitTemporalPixel.bytecode.empty() || oitCompositePixel.bytecode.empty())
    {
